...
@conversation_router.get("/{conversation_id}", response_model=list[MessageResponse], description="Read messages in a conversation")
...
@conversation_router.get("/{user}/contacts", response_model=list[UserResponse], description="Get all users with whom the current user has conversations")
